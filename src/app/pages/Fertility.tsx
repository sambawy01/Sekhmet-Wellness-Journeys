      ...
      <section className="py-20 bg-[#F0F7F4]">
        <div className="container mx-auto px-6 max-w-[1200px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="font-['Playfair_Display'] text-4xl text-[#0F172A] font-bold mb-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#0D9488] text-center">
                ...
                <span className="font-['Outfit'] text-sm text-[#5D5D5D] uppercase tracking-wide">Success Rate</span>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#14B8A6] text-center">
                <span className="block font-['Playfair_Display'] text-4xl font-bold text-[#0F172A] mb-2">50%</span>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border-t-4 border-[#0F172A] text-center col-span-2">
                <span className="block font-['Playfair_Display'] text-4xl font-bold text-[#0F172A] mb-2">3,000+</span>
                <span className="font-['Outfit'] text-sm text-[#5D5D5D] uppercase tracking-wide">Successful Procedures</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-[1400px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group rounded-2xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300 bg-[#F0F7F4]">
              ...
              <div className="p-8">
                <h3 className="font-['Playfair_Display'] text-2xl font-bold text-[#0F172A] mb-3 group-hover:text-[#0D9488] transition-colors">
                  IVF / ICSI
                </h3>
                <p className="font-['Outfit'] text-[#5D5D5D] mb-6 line-clamp-3">
                ...
                <div className="flex items-center justify-between border-t border-[#0F172A]/10 pt-6">
                  <span className="font-['Space_Mono'] font-bold text-[#14B8A6]">From $2,500</span>
                  <span className="text-[#0D9488] text-sm font-bold uppercase tracking-wide group-hover:underline">Learn More</span>
                </div>
              </div>
            </div>
            ...
            <div className="group rounded-2xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300 bg-[#F0F7F4]">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between border-t border-[#0F172A]/10 pt-6">
                  <span className="font-['Space_Mono'] font-bold text-[#14B8A6]">From $1,800</span>
                  <span className="text-[#0D9488] text-sm font-bold uppercase tracking-wide group-hover:underline">Learn More</span>
                </div>
              </div>
            </div>
            ...
            <div className="group rounded-2xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-300 bg-[#F0F7F4]">
              ...
              <div className="p-8">
                ...
                <div className="flex items-center justify-between border-t border-[#0F172A]/10 pt-6">
                  <span className="font-['Space_Mono'] font-bold text-[#14B8A6]">From $1,200</span>
                  <span className="text-[#0D9488] text-sm font-bold uppercase tracking-wide group-hover:underline">Learn More</span>
                </div>
              </div>
            </div>
