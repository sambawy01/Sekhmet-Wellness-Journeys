    ...
    <div className="min-h-screen bg-[#F0F7F4]">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          {/* Main Content */}
          <article className="lg:col-span-8 lg:col-start-2 max-w-none prose prose-lg prose-slate prose-headings:font-playfair prose-headings:text-[#0F172A]">
            ...
            <h2 id="why-egypt" className="text-3xl font-bold text-[#0F172A] mt-12 mb-6 scroll-mt-24">Why Choose Egypt for Dental Implants?</h2>
            ...
            <h2 id="cost-comparison" className="text-3xl font-bold text-[#0F172A] mt-12 mb-6 scroll-mt-24">Cost Breakdown: Egypt vs. UK & US</h2>
            <p className="text-[#3D3D3D] leading-relaxed mb-6 font-sans">
              ...
              <table className="w-full text-left border-collapse bg-white">
                ...
                <tbody className="font-sans text-sm md:text-base">
                  <tr className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="p-4 font-medium text-[#0F172A]">Single Titanium Implant</td>
                  ...
                  <tr className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="p-4 font-medium text-[#0F172A]">Zirconia Crown</td>
                  ...
                  <tr className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="p-4 font-medium text-[#0F172A]">All-on-4 (Per Jaw)</td>
            ...
            <h2 id="procedure-steps" className="text-3xl font-bold text-[#0F172A] mt-12 mb-6 scroll-mt-24">The Procedure: Step-by-Step</h2>
            ...
            <h2 id="recovery" className="text-3xl font-bold text-[#0F172A] mt-12 mb-6 scroll-mt-24">Recovery & Aftercare</h2>
            <p className="text-[#3D3D3D] leading-relaxed mb-6 font-sans">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 mt-16 flex flex-col md:flex-row gap-6 items-center md:items-start text-center md:text-left">
              ...
              />
              <div>
                <h3 className="font-playfair text-xl font-bold text-[#0F172A] mb-2">About Dr. Ahmed Hassan</h3>
          ...
          <aside className="lg:col-span-3 lg:col-start-11 hidden lg:block space-y-8 sticky top-24 h-fit">
                   ...
                   <a 
                     ...
                     className={`block text-sm font-sans transition-colors ${
                       activeSection === item.id 
                         ...
                         : 'text-gray-600 hover:text-[#0F172A] pl-3 border-l-2 border-transparent'
                     }`}
                   >
                     {item.label}
                   </a>
             ...
             {/* CTA Card */}
             <div className="bg-[#0F172A] text-white p-6 rounded-xl shadow-lg text-center relative overflow-hidden">
               ...
               <div className="space-y-4">
                 {[1, 2, 3].map(i => (
                   <div key={i} className="group cursor-pointer">
                     ...
                     <h4 className="font-bold text-sm text-[#0F172A] group-hover:text-[#C5A059] transition-colors line-clamp-2">
      ...
      <div className="bg-white py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <h2 className="font-playfair text-3xl text-[#0F172A] mb-8 text-center">More from the Journal</h2>
               ...
               <div key={i} className="group">
                 <div className="h-48 rounded-xl overflow-hidden mb-4 relative">
                   <img 
                     ...
                     alt="Related"
                   />
                   <span className="absolute top-3 left-3 bg-white/90 backdrop-blur text-xs font-bold px-2 py-1 rounded text-[#0F172A]">
