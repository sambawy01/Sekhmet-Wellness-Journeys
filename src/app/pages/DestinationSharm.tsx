    ...
    <div className="bg-[#F0F7F4]" style={{ direction: isRTL ? 'rtl' : 'ltr' }}>
        ...
        <div className="relative h-full flex items-center justify-start px-6 md:px-12 lg:px-20">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[#0D9488] font-['Outfit'] font-semibold text-sm tracking-widest uppercase">
                {t('dest.sharm.badgeLocation')}
              </span>
            </div>

            <h1 className="text-5xl md:text-7xl font-['Outfit'] font-bold text-white mb-4 leading-tight">
              {t('dest.sharm.title')}
            </h1>

            <p className="text-2xl md:text-3xl text-white/90 font-['Outfit'] font-light mb-6">
              {t('dest.sharm.subtitle')}
            </p>

            <p className="text-lg text-white/80 font-['Outfit'] max-w-xl mb-8 leading-relaxed">
            ...
            <Link to="/consultation">
              <Button className="bg-[#0D9488] hover:bg-[#0a7468] text-white font-['Outfit'] px-8 py-3 rounded-lg transition-colors">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-20">
        <motion.div {...fadeInUp} className="max-w-4xl mx-auto">
          <p className="text-lg text-[#1A2332] font-['Outfit'] leading-relaxed mb-12">
          ...
          >
            <motion.div variants={staggerItem} className="text-center">
              <p className="text-4xl font-bold text-[#0D9488] font-['Outfit'] mb-2">
                {t('dest.sharm.stat1Number')}
              </p>
              <p className="text-[#1A2332] font-['Outfit']">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-20 bg-white">
        <motion.div {...fadeInUp} className="max-w-6xl mx-auto mb-12">
          <h2 className="text-4xl md:text-5xl font-bold font-['Outfit'] text-[#1A2332] mb-4">
        ...
        >
          ...
          >
            ...
            <div className="p-8">
              <h3 className="text-2xl font-bold font-['Outfit'] text-[#1A2332] mb-2">
                {t('dest.sharm.naamaBayTitle')}
              </h3>
              <p className="text-[#0D9488] font-['Outfit'] font-semibold text-sm mb-4">
                {t('dest.sharm.naamaBaySubtitle')}
              </p>
              <ul className="space-y-3 text-[#1A2332] font-['Outfit'] text-sm leading-relaxed">
        ...
        >
          {[
            ...
            >
              ...
              <h3 className="text-lg font-bold font-['Outfit'] text-[#1A2332] mb-2">
                {t(`dest.sharm.activity${activity.charAt(0).toUpperCase() + activity.slice(1)}Title`)}
              </h3>
              <p className="text-sm text-[#1A2332]/70 font-['Outfit']">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-20 bg-white">
        ...
        >
          <motion.div variants={staggerItem} className="bg-[#F0F7F4] rounded-lg p-8 border border-[#0D9488]/20">
            <h3 className="text-2xl font-bold font-['Outfit'] text-[#1A2332] mb-4">
              {t('dest.sharm.sohoSquareTitle')}
            </h3>
            <ul className="space-y-2 text-[#1A2332] font-['Outfit'] text-sm">
          ...
          <motion.div variants={staggerItem} className="bg-[#F0F7F4] rounded-lg p-8 border border-[#0D9488]/20">
            ...
            <p className="text-[#1A2332] font-['Outfit'] text-sm mb-4">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-20">
        ...
        {/* Sharks Bay Hotels */}
        <motion.div {...fadeInUp} className="max-w-6xl mx-auto mb-12">
          <h3 className="text-2xl font-bold font-['Outfit'] text-[#0D9488] mb-6">
          ...
          >
            ...
            >
              <div className="h-48 bg-gradient-to-br from-[#0D9488] to-[#086860]" />
              <div className="p-6">
                <h4 className="text-xl font-bold font-['Outfit'] text-[#1A2332] mb-2">
                  {t('dest.sharm.fourSeasonsProp')}
                </h4>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[#0D9488] font-['Outfit'] font-semibold">9.6</span>
                  <span className="text-sm text-[#1A2332]/70">★★★★★</span>
                </div>
                <ul className="space-y-2 text-sm text-[#1A2332] font-['Outfit']">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[#0D9488] font-['Outfit'] font-semibold">9.5</span>
                  <span className="text-sm text-[#1A2332]/70">★★★★★</span>
                </div>
                <ul className="space-y-2 text-sm text-[#1A2332] font-['Outfit']">
        ...
        <motion.div {...fadeInUp} className="max-w-6xl mx-auto mb-12">
          ...
          >
            ...
            >
              <div className="h-48 bg-gradient-to-br from-[#0D9488] to-[#086860]" />
              <div className="p-6">
                <h4 className="text-lg font-bold font-['Outfit'] text-[#1A2332] mb-2">
                  {t('dest.sharm.rixosSeagateProp')}
                </h4>
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[#0D9488] font-['Outfit'] font-semibold">9.4</span>
                  <span className="text-sm text-[#1A2332]/70">★★★★★</span>
                </div>
                <p className="text-xs text-[#1A2332]/70 font-['Outfit']">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[#0D9488] font-['Outfit'] font-semibold">9.7</span>
                  <span className="text-sm text-[#1A2332]/70">★★★★★</span>
                </div>
                <p className="text-xs text-[#1A2332]/70 font-['Outfit']">
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[#0D9488] font-['Outfit'] font-semibold">9.1</span>
                  <span className="text-sm text-[#1A2332]/70">★★★★★</span>
                </div>
                <ul className="space-y-2 text-xs text-[#1A2332]/70 font-['Outfit']">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className="text-[#0D9488] font-['Outfit'] font-semibold">9.3</span>
                  <span className="text-sm text-[#1A2332]/70">★★★★★</span>
                </div>
                <ul className="space-y-2 text-xs text-[#1A2332]/70 font-['Outfit']">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-20 bg-white">
        <motion.div {...fadeInUp} className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold font-['Outfit'] text-[#1A2332] mb-4">
            {t('dest.sharm.medicalTitle')}
          </h2>
          <div className="h-1 w-20 bg-[#0D9488] mb-8" />

          <p className="text-[#1A2332]/80 font-['Outfit'] leading-relaxed mb-8">
          ...
          >
            ...
            >
              <h3 className="text-xl font-bold font-['Outfit'] text-[#1A2332] mb-3">
                {t('dest.sharm.hospital1Name')}
              </h3>
              <ul className="space-y-2 text-sm text-[#1A2332]/70 font-['Outfit']">
          ...
          <p className="text-[#1A2332]/70 font-['Outfit'] text-sm mt-8 italic">
      ...
      <section className="px-6 md:px-12 lg:px-20 py-20 bg-gradient-to-r from-[#0D9488] to-[#086860]">
        ...
        >
          ...
          <p className="text-white/90 font-['Outfit'] text-lg mb-8">
            {t('dest.sharm.finalCTAText')}
          </p>
          <Link to="/consultation">
            <Button className="bg-white hover:bg-white/90 text-[#0D9488] font-['Outfit'] px-8 py-3 rounded-lg transition-colors font-semibold">
