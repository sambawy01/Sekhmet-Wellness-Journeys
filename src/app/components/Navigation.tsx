      ...
      {isMobileMenuOpen && (
        ...
        >
          <nav className="flex flex-col gap-6 mb-12">
            ...
            <MobileNavLink to="/how-it-works" label={t("nav.howItWorks")} onClick={() => setIsMobileMenuOpen(false)} />
            <MobileNavLink to="/pricing" label={t("nav.pricing")} onClick={() => setIsMobileMenuOpen(false)} />
            <MobileNavLink to="/patient-stories" label={t("nav.stories")} onClick={() => setIsMobileMenuOpen(false)} />
            <MobileNavLink to="/travel-guide" label={t("nav.travelGuide")} onClick={() => setIsMobileMenuOpen(false)} />
            <MobileNavLink to="/faq" label={t("nav.faq")} onClick={() => setIsMobileMenuOpen(false)} />
          </nav>
