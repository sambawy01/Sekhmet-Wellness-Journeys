...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-transparent border-2 border-[#0D9488] text-[#0D9488] hover:bg-[#0D9488]/10 active:bg-[#0D9488]/20",
    ...
    link: "bg-transparent text-[#14B8A6] px-0 py-2 hover:text-[#0D9488] underline decoration-2 underline-offset-4 hover:decoration-[#0D9488] transition-colors duration-200",
    dark: "bg-[#0F172A] text-white hover:bg-[#1A2632] hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:shadow-sm"
  };
  ...
  // Prompt says "(4) Text Link: teal #14B8A6 underline. Hover: gold."
