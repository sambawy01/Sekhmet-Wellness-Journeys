  ...
  return (
    <section className="bg-gradient-to-r from-[#0D9488] to-[#9A6030] py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-[1440px] relative z-10 text-center">
        ...
        >
          <h2 className="font-['Outfit'] text-4xl md:text-5xl font-bold text-[#1A2332] leading-tight">
            Your Journey Starts With a Conversation
          </h2>
          
          <p className="font-['Outfit'] text-xl text-[#1A2332]/80 leading-relaxed font-medium">
            Get a free, no-obligation consultation and personalized quote within 24 hours. We'll handle the rest.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
            <button className="bg-[#1A2332] text-white px-8 py-4 rounded-full font-['Outfit'] font-bold text-lg hover:bg-white hover:text-[#1A2332] transition-all duration-300 shadow-xl flex items-center gap-3 group min-w-[260px] justify-center">
              <CalendarCheck className="w-5 h-5 group-hover:scale-110 transition-transform" />
              Book Free Consultation
            </button>
            
            <button className="bg-[#25D366] text-white px-8 py-4 rounded-full font-['Outfit'] font-bold text-lg hover:bg-white hover:text-[#25D366] transition-all duration-300 shadow-xl flex items-center gap-3 group min-w-[260px] justify-center">
