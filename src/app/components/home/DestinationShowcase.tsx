...
const DestinationCard = ({ 
  ...
  >
    ...
    />
    <div className="absolute inset-0 bg-gradient-to-t from-[#1A2332] via-[#1A2332]/40 to-transparent opacity-90 group-hover:opacity-80 transition-opacity" />
    ...
    <div className="absolute bottom-0 left-0 w-full p-8 flex flex-col justify-end h-full">
      <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-500">
        <div className="bg-[#0D9488] text-[#1A2332] text-xs font-bold px-3 py-1 rounded-full w-fit mb-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
          {badge}
        </div>
...
export const DestinationShowcase: React.FC = () => {
  return (
    <section className="bg-[#1A2332] py-24 relative overflow-hidden">
      {/* Background Pattern */}
      <div 
