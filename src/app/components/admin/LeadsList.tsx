  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#1A2332]">Leads</h1>
          <p className="text-[#64748B] text-sm mt-1">{totalCount} total leads</p>
        </div>
        <button
          onClick={exportCSV}
          className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl text-sm font-medium text-[#1A2332] hover:bg-gray-50 transition-colors"
        >
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-all text-sm"
          />
        </div>
        <div className="relative">
          <Filter size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#64748B]" />
          <select
            value={stageFilter}
            onChange={(e) => {
            ...
            className="pl-10 pr-8 py-2.5 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#0D9488]/30 focus:border-[#0D9488] transition-all text-sm bg-white appearance-none cursor-pointer min-w-[200px]"
          >
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-50 text-left">
                    <th className="px-6 py-3 text-xs font-medium text-[#64748B] uppercase tracking-wider">Patient</th>
                    ...
                    <th className="px-6 py-3 text-xs font-medium text-[#64748B] uppercase tracking-wider">Budget</th>
                  </tr>
                </thead>
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-[#1A2332] font-medium px-2">
                    {page + 1} / {totalPages}
                  </span>
                  <button
